...
const Header = ({ companyName, clientName, month, reportDate, clientBrandColor, logo }) => {
  return (
    <header className="bg-white shadow-md rounded-lg mb-8 overflow-hidden">
      <div className="relative p-6 lg:p-8 text-white" style={{ backgroundColor: clientBrandColor }}>
        {logo && (
          <img 
            src={logo} 
        ...
        <h1 className="text-3xl lg:text-4xl font-extrabold mb-2">Monthly Progress Report</h1>
